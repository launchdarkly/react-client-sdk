...
This version of the LaunchDarkly SDK is compatible with versions 16.3.0 and later of React because it uses React's Context API. However, if you are using the SDK's Hooks API or `asyncCreateLDProvider`, then you must use React version 16.8.0 or later.
